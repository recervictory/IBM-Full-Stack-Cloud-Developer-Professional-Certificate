# Generated by Django 4.0.4 on 2022-04-12 04:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='crud.user')),
                ('occupation', models.CharField(choices=[('student', 'student'), ('developer', 'developer'), ('data_scientist', 'data_scientist'), ('dba', 'dba')], default='student', max_length=20)),
